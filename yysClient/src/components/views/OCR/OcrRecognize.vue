  ...
  <div class="ocr-recognize">
    ...
    <div class="ocr-recognize-cnt">
      ...
      <div style="text-align: center;">
        <van-uploader preview-size="108px" :after-read="afterRead" v-model="fileList" multiple :max-count="1" />
      ...
      <van-button type="primary" size="large" @click="startOcrRecognize" color="#139B7F" style="
          position: fixed;
          left: 16px;
          bottom: 40px;
